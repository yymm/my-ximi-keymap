...
[_RAISE] = LAYOUT_ximi(
  ...
  _______,   _______, _______, _______, _______, KC_MS_BTN1,   KC_MS_BTN2, _______, S(KC_LBRC), S(KC_RBRC), S(KC_SLSH), S(KC_BSLS),
...
[_LOWER] = LAYOUT_ximi(
  ...
  _______, _______, _______, _______, _______, KC_MS_BTN1,   KC_MS_BTN2, _______, KC_LBRC,    KC_RBRC,   S(KC_SLSH), S(KC_BSLS),
